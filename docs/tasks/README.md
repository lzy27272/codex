...
|---|---|---|---|---|
| GROUP-MANAGEMENT-WORK-PLAN-V1 | 集团管理角色与周/月工作计划 | PILOT.8 BATCH A/B CODE COMPLETE / FEATURES OFF / C—D NOT STARTED / NOT DEPLOYED | PRODUCT-V1.4口径不变；批次A已完成业务任职、V39与功能门禁，批次B已完成董事长仅向GM/副总交办、专用最小投影及本人验收/退回。区域经理继续冻结，真实人员未映射，运行库未迁移；计划审批转任务和提醒仍待C—D批次 | [批次B实施记录](./GROUP-MANAGEMENT-ROLE-AND-WORK-PLAN-BATCH-B-IMPLEMENTATION-REPORT.md) · [批次A实施记录](./GROUP-MANAGEMENT-ROLE-AND-WORK-PLAN-BATCH-A-IMPLEMENTATION-REPORT.md) · [正式技术冻结](../GROUP-MANAGEMENT-ROLE-AND-WORK-PLAN-TECHNICAL-FREEZE.md) · [实施计划](./GROUP-MANAGEMENT-ROLE-AND-WORK-PLAN-V1.1-IMPLEMENTATION-PLAN.md) |
